...
?>
	...
	include 'classes/ifscsearch.php';
...
$keywords = "IFSC code finder, ifsc code, ifsc finder, find ifsc code";
	...
	if(!isset($_GET['q'])){
	    $title = "Search Bank By IFSC Code - Sarkari Bank";
	    $des = "Locate Your Bank By Just Putting The IFSC Code Given On Checkbook Or Passbook Of Your Bank Account.";
		$keywords = "IFSC code finder, ifsc code, ifsc finder, find ifsc code";
	}else{
...
<link rel="canonical" href="https://ifsc.sarkaribank.com/">
<meta property="og:locale" content="en_US">
<meta property="og:type" content="website">
<meta property="og:title" content="<?php echo $title; ?>">
<meta property="og:description" content="<?php echo $des; ?>">
<meta property="og:url" content="https://sarkaribank.com/">
...
<div class="header-logo"><a href="https://ifsc.sarkaribank.com/"><img width="200" height="30" src="images/sarkari-bank-logo.png" alt="SarkariBank IFSC Code"></a></div>
<div class="nav-mmemu">
  <a target="blank" href="https://sarkaribank.com/">Home</a>
  <a target="blank" href="https://ifsc.sarkaribank.com/search-by-ifsc">IFSC Code</a>
  ...
  <a href="javascript:void(0);" class="icon" onclick="myFunction()">&#9776;</a>
	    ...
	    <div class='main-search-details'><h1>Find Branch Details/Address/MICR Code By IFSC Code.</h1><div class='search-box'><form action='' method='GET'>
        <input type="text" placeholder="IFSC Code ex:SBIN0000001" name="q" >
